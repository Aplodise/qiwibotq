const TOKEN = "1211001622:AAF6oXN8YLxsTjot4S69dVRJcgBNWibuXx0";
const NUMBER = "79855162003";
const CHANNEL_USERNAME = "balanceqiwiotziv";
const BOT_USERNAME = "balanceqiwi_bot";
...
const bot = new Telegram(1211001622:AAF6oXN8YLxsTjot4S69dVRJcgBNWibuXx0, {
	polling: true
});
...
📲 QIWI для оплаты: <code>${79855162003}</code>
💵 Сумма: ${amount}₽
...
Вы можете просмотреть отзывы покупателей и убедиться, что мы честные.`, {
			reply_markup: {
				inline_keyboard: [
					[
						{ text: "🅾️ Отзывы", url: `https://t.me/${balanceqiwiotziv}` }
					]
				]
			}
		});
...
Ваша реферальная ссылка: https://t.me/${balanceqiwi_bot}?start=${message.from.id}`);
	}
});
